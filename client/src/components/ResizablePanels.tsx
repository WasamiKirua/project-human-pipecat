  ...
  return (
    <div ref={containerRef} className="relative flex-1 h-full">
      ...
      <div
        ...
        className="cursor-row-resize z-10 bg-border/50 hover:bg-border transition-colors duration-200"
        onMouseDown={handleMouseDown}
      >
        <div className="absolute inset-x-0 -top-2 -bottom-2" />
        <div className="h-full flex items-center justify-center">
          <div className="w-full h-0.5 bg-border opacity-50"></div>
          <div className="absolute left-1/2 -translate-x-1/2">
            <span className="text-muted-foreground text-xs bg-background/90 px-2 py-0.5 rounded-full shadow-sm border border-border">
              ⋮⋮
            </span>
          </div>
        </div>
